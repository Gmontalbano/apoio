...
def make_class():
    ...
    if uploaded_file is not None:
        ...
        df.loc[(df['DATA DE NASCIMENTO'] >= '2011-06-30') & (
                    df['DATA DE NASCIMENTO'] <= '2012-06-30'), 'CLASSE'] = 'COMPANHEIRO'
        df.loc[(df['DATA DE NASCIMENTO'] >= '2010-06-30') & (
                    df['DATA DE NASCIMENTO'] <= '2011-06-30'), 'CLASSE'] = 'PESQUISADOR'
        df.loc[(df['DATA DE NASCIMENTO'] >= '2009-06-30') & (
                    df['DATA DE NASCIMENTO'] <= '2010-06-30'), 'CLASSE'] = 'PIONEIRO'
        df.loc[(df['DATA DE NASCIMENTO'] >= '2008-06-30') & (
                    df['DATA DE NASCIMENTO'] <= '2009-06-30'), 'CLASSE'] = 'EXCURSIONISTA'
        df.loc[(df['DATA DE NASCIMENTO'] >= '2007-06-30') & (
                    df['DATA DE NASCIMENTO'] <= '2008-06-30'), 'CLASSE'] = 'GUIA'
